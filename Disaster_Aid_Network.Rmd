...
```{r,echo=TRUE,results='markup',warning=FALSE,message=FALSE,fig.width=12,fig.height=10, dpi=100,out.width='1200px',out.height='1000px'}
...
cut90 <- quantile(as.vector(aid_m[aid_m>0]),0.8)
av_f <- filter(cutoff = cut90,
               edge_matrix = aid_m,
               vertex_colors = V(av)$color,
               vertex_names = all, 
